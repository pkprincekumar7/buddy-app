...
/** @param {{ x?: number, y?: number, width?: number, height?: number, value?: number }} props */
...
const buildCustomTick = (chartData) =>
  /** @param {{ x?: number, y?: number, payload?: any }} props */ function CustomTick({
    x,
    y,
    payload,
  }) {
...
const buildCustomTooltip = (chartData) =>
  /** @param {{ active?: boolean, payload?: any[] }} props */ function CustomTooltip({
    active,
    payload,
  }) {
