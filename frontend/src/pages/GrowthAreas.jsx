  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (cancelled) return;
        const allDocs = Array.isArray(areas?.areas) ? areas.areas : [];
        const done = new Set(
          allDocs
            .filter(
              (a) =>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 md:py-12">
          ...
          {GROWTH_AREAS.map((area, i) => {
            ...
            return (
              <motion.button
                ...
                onClick={() => navigate(`/GrowthAreas/${childId}/Activity/${area.urlName}?q=1`)}
        ...
        <PageActions
          ...
          left={
            <Button
              variant="outline"
              onClick={() => navigate(`/PersonalityJourney/${childId}`)}
