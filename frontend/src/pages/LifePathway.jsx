              ...
              >
                ...
                {completedAreas.length > 0 && (
                  <motion.div {...slideUp(1.6)} className="space-y-4">
                    ...
                    <p className="text-slate-400">
                      Recommendations for each area for {childData?.name}
                    </p>
                  ...
                  {childData?.name && (
                    <div className="mx-auto max-w-3xl rounded-2xl border border-amber-500/20 bg-card p-8">
                      ...
                      <p className="text-xl font-bold leading-relaxed text-white md:text-2xl">
                        ...
                        and <span className="text-emerald-400">{childData.name}</span> to Buddy360.
                        We look forward to powering up your life in all possible dimensions.
                      </p>
                    </div>
                  )}
