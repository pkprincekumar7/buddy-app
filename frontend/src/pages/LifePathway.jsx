...
/** @param {{ cx?: number, cy?: number, payload?: any, milestoneAgeColorMap: any }} props */
    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        >
                ...
                {completedAreas.map((area) => (
                  <span
                    ...
                    className={cn(
                      ...
                      areaBgTw[area.area_id] ?? 'bg-emerald-500',
                    )}
                  >
          ...
          {/* Chart */}
          <motion.div {...slideUp(0.8)} className="border-edge rounded-2xl bg-card p-6 md:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="border-edge-faint rounded-xl bg-surface-elevated p-4">
                  ...
                  <p className="text-sm text-slate-400">
                    {profile?.summary ||
                      `${childData?.name} shows natural growth through standard educational pathways with typical developmental milestones.`}
                  </p>
                </div>
                <div className="border-edge-faint rounded-xl bg-surface-elevated p-4">
              ...
              <div className="space-y-4">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-bold text-white">
                    {childData?.name}'s Journey with Buddy360
                  </h3>
                </div>
                ...
                <div className="bg-brand-teal rounded-xl border border-teal-500/20 p-4">
                  ...
                  <p className="text-sm text-slate-400">
                    {profile?.summary ||
                      `${childData?.name} experiences accelerated holistic growth through personalized guidance, targeted skill development, and continuous support.`}
                    {completedAreas.length > 0 &&
          ...
          {completedAreas.length > 0 && (
            <motion.div {...slideUp(1.6)} className="space-y-4">
              <h2 className="text-2xl font-bold tracking-tight text-white">Growth Area Insights</h2>
            ...
            {childData?.name && (
              <div className="mx-auto max-w-3xl rounded-2xl border border-amber-500/20 bg-card p-8">
                ...
                <p className="text-xl font-bold leading-relaxed text-white md:text-2xl">
                  ...
                  and <span className="text-emerald-400">{childData.name}</span> to Buddy360. We
                ...
                {!concernSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-base leading-relaxed text-slate-300">
                      ...
                      to <span className="font-semibold text-emerald-400">{childData?.name}</span>?
                    </p>
                    <TextareaWithVoice
                      value={concernInput}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed text-slate-400">
                        ...
                        <span className="font-semibold text-emerald-400">{childData?.name}</span> on
                        the same.
                      </p>
                    </div>
                    <Button
