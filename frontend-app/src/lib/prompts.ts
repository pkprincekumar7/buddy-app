...
Logistics recap:
• Name / Age / Phase: ${typeof childData.name === 'string' ? childData.name : 'unknown'}, Age ${String(age ?? '')}, life-phase bucket ${lifePhase ?? ''}
• School context: ${typeof childData.school === 'string' ? childData.school : 'not captured'}
• Reported strengths parent listed: ${strengths}
• Interests referenced: ${hobbies}
