...
async def delete_account(
    ...
    # growth_areas/observations/ninety_day_plans are all child-scoped and store
    # user_id, so delete_many by user_id covers every document in one pass.
    await asyncio.gather(
        ...
        db[models.NINETY_DAY_PLANS].delete_many({"user_id": user_id, "location": location}),
    )
